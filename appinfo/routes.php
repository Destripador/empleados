...
'routes' => [
		...
		['name' => 'empleados#listarContactosEmergencia', 'url' => '/empleados/{id_empleado}/contactos-emergencia', 'verb' => 'GET'],
		['name' => 'empleados#crearContactoEmergencia', 'url' => '/empleados/{id_empleado}/contactos-emergencia', 'verb' => 'POST'],
		['name' => 'empleados#actualizarContactoEmergencia', 'url' => '/empleados/{id_empleado}/contactos-emergencia/{id}', 'verb' => 'PUT'],
		['name' => 'empleados#eliminarContactoEmergencia', 'url' => '/empleados/{id_empleado}/contactos-emergencia/{id}', 'verb' => 'DELETE'],
		['name' => 'empleados#marcarContactoEmergenciaPrincipal', 'url' => '/empleados/{id_empleado}/contactos-emergencia/{id}/principal', 'verb' => 'POST'],
		...
		['name' => 'inventario#GetInventarioHistorial', 'url' => '/inventario/equipos/{id_equipo}/historial', 'verb' => 'GET'],
		...
		['name' => 'mantenimiento#technicians', 'url' => '/inventario/mantenimientos/tecnicos', 'verb' => 'GET'],
		['name' => 'mantenimiento#groups', 'url' => '/inventario/mantenimientos/grupos', 'verb' => 'GET'],
		['name' => 'mantenimiento#createGroup', 'url' => '/inventario/mantenimientos/grupos', 'verb' => 'POST'],
		['name' => 'mantenimiento#groupMaintenances', 'url' => '/inventario/mantenimientos/grupos/{id}/equipos', 'verb' => 'GET'],
		['name' => 'mantenimiento#cancelGroup', 'url' => '/inventario/mantenimientos/grupos/{id}/cancelar', 'verb' => 'POST'],
		['name' => 'mantenimiento#assignGroupTechnician', 'url' => '/inventario/mantenimientos/grupos/{id}/tecnico', 'verb' => 'POST'],
		['name' => 'mantenimiento#group', 'url' => '/inventario/mantenimientos/grupos/{id}', 'verb' => 'GET'],
		['name' => 'mantenimiento#eligibleEquipment', 'url' => '/inventario/mantenimientos/departamentos/{id}/equipos', 'verb' => 'GET'],
		['name' => 'mantenimiento#overdue', 'url' => '/inventario/mantenimientos/atrasados', 'verb' => 'GET'],
		['name' => 'mantenimiento#duplicates', 'url' => '/inventario/mantenimientos/duplicados', 'verb' => 'GET'],
		['name' => 'mantenimiento#equipmentHistory', 'url' => '/inventario/mantenimientos/equipos/{id}/historial', 'verb' => 'GET'],
		['name' => 'mantenimiento#start', 'url' => '/inventario/mantenimientos/{id}/iniciar', 'verb' => 'POST'],
		['name' => 'mantenimiento#schedule', 'url' => '/inventario/mantenimientos/{id}/programar', 'verb' => 'POST'],
		['name' => 'mantenimiento#complete', 'url' => '/inventario/mantenimientos/{id}/completar', 'verb' => 'POST'],
		['name' => 'mantenimiento#reschedule', 'url' => '/inventario/mantenimientos/{id}/reprogramar', 'verb' => 'POST'],
		['name' => 'mantenimiento#cancel', 'url' => '/inventario/mantenimientos/{id}/cancelar', 'verb' => 'POST'],
		['name' => 'mantenimiento#notApplicable', 'url' => '/inventario/mantenimientos/{id}/no-aplica', 'verb' => 'POST'],
		['name' => 'mantenimiento#assignTechnician', 'url' => '/inventario/mantenimientos/{id}/tecnico', 'verb' => 'POST'],
		['name' => 'mantenimiento#updateChecklist', 'url' => '/inventario/mantenimientos/{id}/checklist', 'verb' => 'PATCH'],
		['name' => 'mantenimiento#updateWork', 'url' => '/inventario/mantenimientos/{id}/trabajo', 'verb' => 'PATCH'],
		['name' => 'mantenimiento#maintenance', 'url' => '/inventario/mantenimientos/{id}', 'verb' => 'GET'],
		...
		['name' => 'compra_solicitud#history','url' => '/compras/solicitudes/{id}/historial','verb' => 'GET'],
		['name' => 'compra_solicitud#flow','url' => '/compras/solicitudes/{id}/flujo','verb' => 'GET'],
